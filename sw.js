...
// Activate Event - Evicts old caches
...
// Fetch Event - Network-First for HTML so new updates appear immediately
self.addEventListener('fetch', (event) => {
  const request = event.request;
  if (request.method !== 'GET') return;

  // 1. Navigation / HTML pages: Fetch network first, fallback to offline cache
  ...
  // 2. Google Sheets CSV / API: Network-first
